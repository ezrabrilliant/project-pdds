    ...
    <div className="space-y-8 sm:space-y-12 lg:space-y-16">
      ...
      <section className="text-center py-12 sm:py-16 lg:py-20 relative">
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent animate-pulse">
            🎬 CineHub
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-4">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 px-4">
